  ...
  return (
    <Box p={8}>
      <VStack spacing={6} align="stretch">
        <Box>
          <Heading size="lg" mb={1}>Tool Deep Dive</Heading>
          <Text fontSize="sm" color="gray.500">
            Performance metrics and latency percentiles for all tools
          </Text>
        </Box>
        <Box
          bg="surface.card"
          ...
          <Table size="sm" variant="soft">
            ...
            <Tbody>
              {tools.map((t) => {
                ...
                const mcp = isMcpTool(t.tool_name);
                return (
                  <Tr key={t.tool_name} bg={mcp ? "purple.50" : undefined}>
                    <Td>
                      <ChakraLink
                        as={Link}
